...
log = infolog.log
os.chdir("/content/gdrive/My Drive/Tacotron-2/")
...
def train(args, log_dir, hparams):
	...
	print("---debug:taco_state, GTA_state, wave_state:", taco_state, GTA_state, wave_state)

	if not taco_state:
		log('\n#############################################################\n')
		log('Tacotron Train\n')
		log('###########################################################\n')
		print("---debug before tacotron_train")
		checkpoint = tacotron_train(args, log_dir, hparams)
		print("---debug after tacotron_train")		
		tf.reset_default_graph()
		#print("---after reset_default_graph")
...
def main():
	...
	parser.add_argument('--tacotron_input', default='/content/training_data/trainTill700.txt')
	parser.add_argument('--wavenet_input', default='tacotron_output/gta/map.txt')
	parser.add_argument('--name', help='Name of logging directory.')
	parser.add_argument('--model', default='Tacotron-2')
	parser.add_argument('--input_dir', default='/content/training_data', help='folder to contain inputs sentences/targets')
	...
	parser.add_argument('--summary_interval', type=int, default=500, help='Steps between running summary ops')
	...
	parser.add_argument('--checkpoint_interval', type=int, default=500,help='Steps between writing checkpoints')
