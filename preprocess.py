...
from datasets import preprocessor, thchs30
...
def preprocess(args, input_folders, out_dir, hparams):
	...
	print("linear_dir=",linear_dir)
	print("wav_dir=",wav_dir)
	print("args.n_jobs=",args.n_jobs)

	metadata = thchs30.build_from_path(hparams, input_folders, out_dir, args.n_jobs, tqdm=tqdm)
...
def norm_data(args):
	...
	supported_datasets = ['LJSpeech-1.0', 'LJSpeech-1.1', 'M-AILABS', 'thchs30']
