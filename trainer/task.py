# this file is copied from train.py. the purpose is to provide a module for google cloud platform (GCP) to call as
...
def train(args, log_dir, hparams):
	...
	if not taco_state:
		...
		log('Tacotron Train\n')
		log('###########################################################\n')
		#print("---before tacotron_train")
		checkpoint = tacotron_train(args, log_dir, hparams)
		#print("---after tacotron_train")		
...
def main():
	...
	parser.add_argument('--checkpoint_interval', type=int, default=50,help='Steps between writing checkpoints')
