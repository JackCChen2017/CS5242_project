...
hparams = tf.contrib.training.HParams(
	...
	max_mel_frames = 600,  #Only relevant when clip_mels_length = True, please only use after trying output_per_steps=3 and still getting OOM errors.
	...
	tacotron_adam_beta1 = 0.9, #AdamOptimizer beta1 parameter, default is 0.9
	tacotron_adam_beta2 = 0.999, #AdamOptimizer beta2 parameter
	tacotron_adam_epsilon = 1e-6, #AdamOptimizer Epsilon parameter, default is 1e-6
	...
	tacotron_dropout_rate = 0.5, #dropout rate for all convolutional layers + prenet, default is 0.5
